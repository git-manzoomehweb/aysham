...
document.querySelectorAll('.show-more-view').forEach(button => {
   button.addEventListener('click', function () {
       if (this.getAttribute('data-type') === '0') {
           this.setAttribute('data-type', '1');
           document.querySelector('.text-limit').classList.add('large-view');
           this.textContent = 'پنهان';
       } else {
           this.setAttribute('data-type', '0');
           document.querySelector('.text-limit').classList.remove('large-view');
